...
const validateAttendances_middleware_1 = __importDefault(require("../middlewares/validateAttendances.middleware"));
...
attendancesRouter.post('/attendances', validateAttendances_middleware_1.default.validateCreateAttendance, Attendances_controller_1.default.createAttendance, error_middleware_1.default.handleErrors);
